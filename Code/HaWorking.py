# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 11:50:01 2019
...
#DIR = r'C:\Users\ucasbwh\OneDrive - University College London\PanCam Documents\Rover Level Testing\Data\191107 - TVAC TP02 Testing\20191106_1734_ERJPMW_CRUISE_CHECKOUTS'
#DIR = r'C:\Users\ucasbwh\OneDrive - University College London\PanCam Documents\Rover Level Testing\Data\191022 - PostAcoustic_PreTVAC\ANNEX-2 CCS Logs'
#DIR = r'C:\Users\ucasbwh\OneDrive - University College London\PanCam Documents\Rover Level Testing\Data\190819 - Rover Cal\19082019 Morning - PanCam\CCS LOGS'
DIR = r'C:\Users\ucasbwh\OneDrive - University College London\PanCam Documents\Rover Level Testing\Data\190819 - Rover Cal\19082019 Afternoon - PanCam\CCS_LOGS'
        ...
        while PKT_HD[0] != "<END_DATA_BLOCK>\n":
            ...
            if PKT_HD[2][12:-1] == "AB.TM.MRSS0697":
                ...
                # Filter for only science packets                    
                    ...
                    PROC_DIR = os.path.join(DIR, "PROC\IMG_RAW")
                    ...
                    write_file = os.path.join(PROC_DIR, write_filename)
