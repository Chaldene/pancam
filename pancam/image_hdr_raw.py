...
def decodeRAW_ImgHDR(header_bytes):
    ...
    #Byte 18-23
    img_info['PIU_Time'] = upf('u48', header_bytes, offset=144)[0]          #No label in ICD
    ...
    if (img_info['Cam'] == 1) or (img_info['Cam'] == 2):
        ...
        #Byte 25-30
        img_info['W_Start_Time'] = upf('u48', header_bytes, offset=200)[0]  #PAN_TM_WAC_DT_ITS
        #Byte 31-36
        img_info['W_Time'] = upf('u48', header_bytes, offset=248)[0]        #PAN_TM_WAC_DT_WTS   
        #Byte 37-40
